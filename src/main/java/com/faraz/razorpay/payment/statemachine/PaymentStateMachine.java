...
import com.faraz.razorpay.common.exception.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION = Map.ofEntries(
            ...
            Map.entry(new Transition(PaymentStatus. CAPTURED, PaymentEvent.REFUND_INITIATED), PaymentStatus. PARTIALLY_REFUNDED),
